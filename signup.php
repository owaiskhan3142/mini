...
if(isset($_POST['submit'])){
    ...
    $con = mysqli_connect($server,$username,$password,"mini");
    ...
    $sql = "INSERT INTO `members` (`fname`, `lname`, `gender`, `age`, `contact`, `email`, `password`) VALUES ('$fname', '$lname', '$gender', '$age', '$contact', '$email', '$password')"; 
    //echo $sql;
    ...
    <div>
      <form class="modal-content" action="./signup.php" method ="post">
        <div class="container2">
          ...
          <input type="text" placeholder="Repeat Gender" name="gender" required>

          <label><b>Age</b></label>
          <input type="text" placeholder="Repeat Age" name="age" required>

          <label><b>Contact</b></label>
          <input type="text" placeholder="Repeat Copntact" name="contact" required>
